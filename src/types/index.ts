...
export type SearchSortMode = 'rating' | 'fairness' | 'fast' | 'quiet';

/**
 * "Agent mode" — five presets the user picks instead of fiddling with
 ...
 */
export type AgentMode = 'fair' | 'fast' | 'vibe' | 'quiet' | 'now';
