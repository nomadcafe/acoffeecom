...
export const messages: MessageDict = {
  ...
  'showcase.row6Title': "Pin a café you run or love.",
  'showcase.row6Body': "Set a featured café on your profile and ACoffee shows ↗ shared by @yourname on its search results. Free passive promotion for cafés that already love you.",
