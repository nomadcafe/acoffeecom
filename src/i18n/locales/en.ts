...
export const messages: MessageDict = {
  ...
  'setup.saving': 'Saving…',
  'setup.back': 'Back',
  'setup.skipAll': 'Skip for now',
  'setup.needSignIn': 'Sign in first to set up your profile.',
  'setup.usernameTitle': 'Pick your handle',
  'setup.usernameLead': "This is what your friends will type — acoffee.com/yourname.",
  'setup.usernameHint': 'Lowercase letters, numbers, and dashes. Starts with a letter, 3–30 characters.',
  'setup.homeBaseTitle': 'Where do you usually grab coffee?',
  'setup.homeBaseLead': 'Anchors AI cafe picks halfway between you and whoever books with you.',
  'setup.homeBaseLabel': 'Home base address',
  'setup.homeBasePlaceholder': 'Coffee shop, neighbourhood, or city',
  'setup.homeBaseHint': "Used only for booking — never shown publicly.",
  'setup.homeBaseSaveFailed': "Couldn't save the address. Try again?",
  'setup.availabilityTitle': 'When are you open for coffee?',
  ...
  'setup.presetAnytimeSub': 'All seven days, generous window.',
  'setup.doneTitle': "You're set ☕",
  'setup.doneLead': 'Share your link to start getting coffee bookings.',
  'setup.copyLink': 'Copy link',
  'setup.copied': 'Copied!',
  'setup.viewProfile': 'View your profile',
  ...
  'account.themeTitle': 'Profile theme',
  'account.themeHint': 'Pick the accent color shown on your public profile. Saved instantly.',
  'account.themeSaved': 'Theme updated.',
  'account.themeSaveFailed': "Couldn't save the theme. Try again?",
  'account.themePreset.default': 'Espresso',
  'account.themePreset.sage': 'Sage',
  'account.themePreset.sunset': 'Sunset',
  'account.themePreset.midnight': 'Midnight',
  'account.themePreset.rose': 'Rose',
  'account.themePreset.mono': 'Mono',
  ...
  'bookingWidget.successBody': 'Coffee with {{handle}} is confirmed for {{when}}.',
  'bookingWidget.successFollowUp': "Both of you will get a calendar invite by email shortly with the café details.",
  ...
  'bookings.proposeNewTimeReset': 'Keep the original time',
