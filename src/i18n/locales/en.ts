...
export const messages: MessageDict = {
  ...
  /* Home showcase (anonymous-visitor hero). The 5-card secondary
  ...
  'bookings.signedOutTitle': 'Coffee bookings on your page',
  'bookings.signedOutLead': 'Share your link, get coffee invites. ACoffee picks a fair café between you and the visitor — you just say yes.',
  'bookings.signedOutStep1Title': 'Set your availability',
  'bookings.signedOutStep1Body': 'Pick the weekly hours people can book, plus the city you usually meet in.',
  'bookings.signedOutStep2Title': 'Share acoffee.com/yourname',
  'bookings.signedOutStep2Body': 'Drop the link in your bio, signature, or DM. The other side doesn’t need an account.',
  'bookings.signedOutStep3Title': 'Approve incoming requests',
  'bookings.signedOutStep3Body': 'You get an email when someone books. Tap approve, ACoffee suggests a café, and the meeting is set.',
