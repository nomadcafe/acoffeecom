...
export const en: MessageDict = {
  ...
  'account.usernameProSoon': 'Custom acoffee.com/yourname URLs are coming with Pro. Sit tight — once they open, signed-in users will get first pick.',
...
export const ja: MessageDict = {
  ...
  'account.usernameProSoon': 'acoffee.com/yourname のカスタム URL は Pro で公開予定です。サインイン済みのユーザーから先行で選べる予定です。',
...
export const zh: MessageDict = {
  ...
  'passport.visitsShow': '展开 {{count}} 次到访记录',
  'passport.visitsHide': '收起记录',
  ...
  'account.usernamePlaceholder': 'yourname',
  'account.usernameHint': '3–30 个字符；小写字母、数字、_ 或 -。占用未来的 acoffee.com/yourname URL。',
  'account.saveUsername': '保存',
  ...
  'account.usernameInvalid': '3–30 个字符：小写字母、数字、_ 或 -；必须以字母开头。',
  'account.usernameChecking': '检查可用性…',
  'account.usernameAvailable': '可用',
  'account.usernameSaveFailed': '暂时无法保存，再试一次？',
  'account.usernameProSoon': 'acoffee.com/yourname 自定义链接将随 Pro 开放，已登录用户届时优先挑选。',
