...
export const en: MessageDict = {
  ...
  'hero.smartNearbyHint': 'Sounds like a nearby search — tap "Show coffee near me" below.',
  ...
  'card.aiSummary': '✨ AI review summary',
...
export const ja: MessageDict = {
  ...
  'hero.smartNearbyHint': '近くの検索のようです。下の「近くのカフェを表示」を使ってください。',
...
export const zh: MessageDict = {
  ...
  'hero.smartNearbyHint': '似乎是附近搜索，请使用下方"显示附近的咖啡店"。',
